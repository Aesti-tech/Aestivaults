...
import styles from "../modules/SideNavigation.module.css";
...
function SideNavigation() {
  ...
  return (
    <div className={styles.leftSide} style={{ "--delay": ".4s" }}>
      <Link to={"/dashboard"}>
        <svg
          viewBox="0 1 511 512"
          fill="currentColor"
      ...
      <Link to={"dashboard/wallet"}>
        <svg
          ...
          className={`${styles.svg} ${styles.wallet} ${
            location.pathname === "/dashboard/wallet" ? styles.active : ""
          }`}
        >
      ...
      <Link to={"dashboard/collection"}>
        <svg
          ...
          strokeLinejoin="round"
          className={`${styles.svg} ${
            location.pathname === "/dashboard/collection" ? styles.active : ""
          }`}
        >
      ...
      <Link to={"dashboard/messages"}>
        <svg
          ...
          fill="currentColor"
          className={`${styles.svg} ${
            location.pathname === "/dashboard/messages" ? styles.active : ""
          }`}
        >
      ...
      <Modal>
        ...
        <Modal.Window name={"logout"}>
          <ConfirmDelete onConfirm={handleLogout} action={"Logout"}>
            Confirm Logout
          </ConfirmDelete>
        </Modal.Window>
      </Modal>
